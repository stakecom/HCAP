...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HealCapital Core healcapital-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  healcapital-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded healcapital transaction") + "\n" +
                               "  healcapital-tx [options] -create [commands]   " + _("Create hex-encoded healcapital transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded healcapital transaction
