...
#ifndef HEALCAPITAL_ZHCAPWALLET_H
#define HEALCAPITAL_ZHCAPWALLET_H
...
public:
    CzHCAPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHCAP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHCAP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //HEALCAPITAL_ZHCAPWALLET_H
