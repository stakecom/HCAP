                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzhcapPathCustom = GetArg("-zhcapbackuppath", "");
    ...
    if(!strzhcapPathCustom.empty()) {
        ui->wallet_customzhcapbackuppath->setText(QString::fromStdString(strzhcapPathCustom));
        ui->wallet_customzhcapbackuppath_label->setVisible(true);
        ui->wallet_customzhcapbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzhcapPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HealCapital RPC console.") + "<br>" +
