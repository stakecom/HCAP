...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HealCapital Core"),
     ...
     * override -datadir in the healcapital.conf file in the default data directory
     * (to be consistent with healcapitald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
