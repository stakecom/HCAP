                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HealCapital Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HealCapital address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and healcapital: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHCAP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HealCapital Core"), this);
    aboutAction->setStatusTip(tr("Show information about HealCapital Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HealCapital"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HealCapital addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HealCapital addresses"));
    ...
    openAction->setStatusTip(tr("Open a HealCapital: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HealCapital Core help message to get a list with possible HealCapital command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HealCapital Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HealCapital network", "", count));
}
...
{
    QString strTitle = tr("HealCapital Core"); // default title
