...
/** Utility functions used by the HealCapital Qt UI.
 */
namespace GUIUtil
{
...
// Render HealCapital addresses in monospace font
...
// Parse "healcapital:" URI into recipient object, return true on successful parsing
