 ...
 */
    ...
    typeWidget->addItem(tr("Received Hcap from zHcap"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zHcap"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zHcap));
