...
public:
    ...
    void setZHcapControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzHCAP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHCAP_clicked();
    void on_pushButtonZHcapControl_clicked();
