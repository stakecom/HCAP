...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HealCapital server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "HealCapital server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HealCapital features */
        {"healcapital", "masternode", &masternode, true, true, false},
        {"healcapital", "listmasternodes", &listmasternodes, true, true, false},
        {"healcapital", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"healcapital", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"healcapital", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"healcapital", "getmasternodecount", &getmasternodecount, true, true, false},
        {"healcapital", "masternodeconnect", &masternodeconnect, true, true, false},
        {"healcapital", "masternodecurrent", &masternodecurrent, true, true, false},
        {"healcapital", "masternodedebug", &masternodedebug, true, true, false},
        {"healcapital", "startmasternode", &startmasternode, true, true, false},
        {"healcapital", "createmasternodekey", &createmasternodekey, true, true, false},
        {"healcapital", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"healcapital", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"healcapital", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"healcapital", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"healcapital", "getmasternodescores", &getmasternodescores, true, true, false},
        {"healcapital", "mnbudget", &mnbudget, true, true, false},
        {"healcapital", "preparebudget", &preparebudget, true, true, false},
        {"healcapital", "submitbudget", &submitbudget, true, true, false},
        {"healcapital", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"healcapital", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"healcapital", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"healcapital", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"healcapital", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"healcapital", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"healcapital", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"healcapital", "checkbudgets", &checkbudgets, true, true, false},
        {"healcapital", "mnsync", &mnsync, true, true, false},
        {"healcapital", "spork", &spork, true, true, false},
        {"healcapital", "getpoolinfo", &getpoolinfo, true, true, false},
        {"healcapital", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzhcapseed", &getzhcapseed, false, false, true},
        {"zerocoin", "setzhcapseed", &setzhcapseed, false, false, true}
...
{
    return "> healcapital-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20201/\n";
}
