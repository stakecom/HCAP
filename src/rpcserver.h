...
/**
 * HealCapital RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzhcapseed(const UniValue& params, bool fHelp);
extern UniValue getzhcapseed(const UniValue& params, bool fHelp);
