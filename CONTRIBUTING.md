Contributing to HealCapital Core
============================

The HealCapital Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HealCapital Core project, and is not to be
confused with overall HealCapital Network Protocol consensus changes.

Whether a pull request is merged into HealCapital Core rests with the project merge
...
Patches that change HealCapital consensus rules are considerably more involved than
...
Where a patch set proposes to change the HealCapital consensus, it must have been
...
The project leader is the release manager for each HealCapital Core release.
